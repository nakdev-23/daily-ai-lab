import { getProfile, isPro, avatarUrlFor } from "@/lib/auth"
...
export default async function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <AppShell displayName={displayName} role={role} pro={isPro(profile)} avatar={avatarUrlFor(profile)} xp={xp} hearts={heart.hearts} unlimitedHearts={heart.unlimited} streak={streak} lang={lang} initialCollapsed={initialCollapsed}>
      {children}
    </AppShell>
  )
}

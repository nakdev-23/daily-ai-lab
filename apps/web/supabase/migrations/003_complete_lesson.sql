-- Migration 003: atomic lesson completion
-- One RPC marks progress AND awards XP / streak / daily counter in a single
-- transaction, replacing the racy read-then-upsert in app code.

...
icon: "tool-chatgpt"
level: "intermediate"
summary: "แอป ChatGPT บน Mac, Windows, iOS และ Android มีฟีเจอร์เฉพาะที่ช่วยให้ใช้งานสะดวกกว่าเว็บ ตั้งแต่ Keyboard Shortcut, Screenshot Analysis ไปจนถึงการใช้เป็น Default Assistant บนมือถือ"
readTime: "6 นาที"
readers: "0"
locked: false
order: 8
...
**macOS:**
1. ไปที่ [chatgpt.com](https://chatgpt.com) แล้วคลิก "Download the app"
2. หรือค้นหา "ChatGPT" ใน Mac App Store
3. ต้องใช้ macOS 14 Sonoma ขึ้นไป

**Windows:**
1. ค้นหา "ChatGPT" ใน Microsoft Store
2. หรือดาวน์โหลดจากเว็บไซต์ OpenAI
3. ต้องใช้ Windows 10 (Build 17763) ขึ้นไป

...
- grok-basic ✅ · elevenlabs-basic ✅

## Next (lessons first, then docs) — 153 lessons left
lovable-basic (6) → midjourney-basic (8) → runway-basic (8) → suno-basic (8) →
codex-basic (12) → codex-advanced (12) → chatgpt-advanced (15) →
claude-advanced (15) → gemini-advanced (15) → claude-code (18) →
claude-cowork (12) → claude-design (12) → claude-other (12) → (any remaining)

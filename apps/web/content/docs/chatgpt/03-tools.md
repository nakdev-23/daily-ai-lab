...
### ข้อควรรู้
Search Query (คำค้นหา) ใช้ Quota (โควต้า — จำนวนการใช้งานที่กำหนดไว้) ของ GPT-5.5 เหมือนกัน ถ้าหมด Quota จะไม่สามารถค้นหาได้
...
| แผน | ขีดจำกัด Voice |
|---|---|
| **Free** | GPT-5.5 mini, สูงสุด 2 ชั่วโมง/วัน |
| **Plus** | GPT-5.5 เกือบไม่จำกัด (มี Fallback — การสลับโมเดล ไป mini เมื่อหมด quota) |
| **Pro** | GPT-5.5 ไม่จำกัด |
